...
export function InvalidTeamsWebhook() {
    return {
        ...
        details: `The provided Teams webhook URL is not a valid URL format. Please check the \`TEAMS_NOTIFICATION_URI\` environment variable or \`teamsWebhook\` configuration option.`,
    };
}
